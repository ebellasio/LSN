...
void System :: initialize_properties(){ // Initialize data members used for measurement of properties
  ...
  // Leddo file properties.dat che contiene i nomi delle variabili (proprieta' del sistema) da calcolare
  ...
  if (input.is_open()){
    while ( !input.eof() ){
      ...
      if( property == "POTENTIAL_ENERGY" ){
        ...
        _measure_penergy = true;    //Il boolno dell'energia potenziale diventa true -> da calcolare
