...
int main (int argc, char *argv[]){
    ...
    //parte 1 - simulo un random walk in 3D partendo nell'origine su un reticolo cubuco di lato 1
    ...
    for ( int j = 0; j < N_passi; j++ ){  //ciclo sui passi del RW
        ...
        for( int i = 0; i < N; i++ ){      //numero di blocchi
            ...
            for ( int m = 0; m < L; m++ ){      //numero di RW per ogni blocco
    ...
    //parte 2 - simulo un random walk in 3D partendo nell'origine nel continuo con passi discreti pari ad a
    // 10000 volte ripeto il RW, ogni RW lo faccio per 100 passi e calcolo la distanza media
    // e la sua incertezza
