...
double f ( double x ){
   return Pi/2.0 * cos( Pi/2.0 * x );
};

double g ( double x ){
   return Pi/4.0 * cos( Pi/2.0 * x ) / ( 1 - x );
};
...
int main (int argc, char *argv[]){
   ...
   //part 1 - stima dell'integrale e della sua incertezza con una distribuzione uniforme tra 0 e 1
   ...
   //stima dell'integrale e della sua incertezza con una distribuzione NON uniforme tra 0 e 1
