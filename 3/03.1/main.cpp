...
int main (int argc, char *argv[]){
   ...
   //part 1 - computo al tempo t=0 il prezzo della European call option e della European put option 
   ...
   //part 2 - computo al tempo t=0 il prezzo della European call option e della European put option 
